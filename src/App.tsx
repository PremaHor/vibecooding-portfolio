...
const SOCIAL_LINKS = [
  ...
  { name: 'Behance', icon: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 3h5.5c1.4 0 2.5.5 3 1.5s.5 2 0 3c-.3.6-.9 1.1-1.5 1.3 1 .3 1.7 1 2 2 .4 1.3.1 2.7-1 3.5-.7.5-1.5.7-2.5.7H3V3z" />
      <path d="M3 9.5h5" />
      <path d="M14 7h6" />
      <path d="M14 11c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4h-1c-1.7 0-3-1.3-3-3" />
    </svg>
